...
var PatientService = (function () {
    function PatientService(httpInt) {
        this.heroesUrl = 'http://localhost:52063/api/patients'; // URL to web api
        this.http = httpInt;
    }
    PatientService.prototype.getAllPatients = function () {
        return this.http.get(this.heroesUrl);
    };
    PatientService.prototype.add = function (loc) {
        return this.http
    ...
    PatientService.prototype.update = function (loc) {
